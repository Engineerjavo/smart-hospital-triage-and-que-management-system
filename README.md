...
The system does that by taking specific patient entry like symptom and type of ailment also severity and with the algorithm 
the patient is reffered to the most available and preferable department or facility  in a given hospital.
Simulation model has a 4x3 matrix keypad for patient input , 16x2 LCD for display and an arduino for the microcontroller.
